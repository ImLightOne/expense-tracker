...
def render(ctx: dict) -> None:
    ...
    with col2:
        ...
        category_options = income_categories if tx_type == "income" else expense_categories
        ...
        is_subscription = st.checkbox(l("Recurring subscription", "Повторювана підписка", "Wiederkehrendes Abo"), disabled=tx_type == "income")
        recurrence = "monthly"
        if is_subscription:
